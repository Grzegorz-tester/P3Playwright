 ...
 */
export class InsinkeratorEuSitemapPage extends SitemapPage {

    constructor(page: Page) {
        super(page);
    }

    readonly wrapper = InsinkeratorEuObjects.SitemapPage.wrapper(this.page);
    readonly heading = InsinkeratorEuObjects.SitemapPage.heading(this.page);
    readonly categoryItemLinks = InsinkeratorEuObjects.SitemapPage.categoryItemLinks(this.page);

    private readonly tabLinks: Record<SitemapCategory, ReturnType<typeof InsinkeratorEuObjects.SitemapPage.productsTabLink>> = {
        'products': InsinkeratorEuObjects.SitemapPage.productsTabLink(this.page),
        'categories': InsinkeratorEuObjects.SitemapPage.categoriesTabLink(this.page),
        'content': InsinkeratorEuObjects.SitemapPage.contentTabLink(this.page),
        'locations': InsinkeratorEuObjects.SitemapPage.locationsTabLink(this.page),
        'product images': InsinkeratorEuObjects.SitemapPage.productImagesTabLink(this.page),
    }
