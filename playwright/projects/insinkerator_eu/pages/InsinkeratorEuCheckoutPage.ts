 ...
 */
export class InsinkeratorEuCheckoutPage extends CheckoutPage {
    ...
    readonly guestCheckoutRadio = InsinkeratorEuObjects.CheckoutPage.signInRadioGuestCheckout(this.page);
    readonly existingCustomerRadio = InsinkeratorEuObjects.CheckoutPage.signInRadioExistingCustomer(this.page);
    readonly guestEmailInput = InsinkeratorEuObjects.CheckoutPage.guestEmailInput(this.page);
    readonly guestContinueButton = InsinkeratorEuObjects.CheckoutPage.guestContinueButton(this.page);

    // --- VERIFIED: GUEST delivery address FORM step ---
    readonly addressFirstName = InsinkeratorEuObjects.CheckoutPage.addressFirstName(this.page);
    readonly addressLastName = InsinkeratorEuObjects.CheckoutPage.addressLastName(this.page);
    readonly addressLine1 = InsinkeratorEuObjects.CheckoutPage.addressLine1(this.page);
    readonly addressCity = InsinkeratorEuObjects.CheckoutPage.addressCity(this.page);
    readonly addressPostcode = InsinkeratorEuObjects.CheckoutPage.addressPostcode(this.page);
    readonly addressSubmitButton = InsinkeratorEuObjects.CheckoutPage.addressSubmitButton(this.page);
    readonly addressAutocompleteListbox = InsinkeratorEuObjects.CheckoutPage.addressAutocompleteListbox(this.page);
    readonly addressAutocompleteOptions = InsinkeratorEuObjects.CheckoutPage.addressAutocompleteOptions(this.page);

    // --- VERIFIED: LOGGED-IN saved-address selection step ---
    readonly loggedInContinueButton = InsinkeratorEuObjects.CheckoutPage.loggedInContinueButton(this.page);
    readonly loggedInAddressOptions = InsinkeratorEuObjects.CheckoutPage.loggedInAddressOptions(this.page);
    readonly loggedInAddressContinueButton = InsinkeratorEuObjects.CheckoutPage.loggedInAddressContinueButton(this.page);

    // --- VERIFIED: delivery-METHOD step, confirmed working end-to-end ---
    readonly deliveryPhoneInput = InsinkeratorEuObjects.CheckoutPage.deliveryPhoneInput(this.page);
    readonly deliveryMethodRadioGroup = InsinkeratorEuObjects.CheckoutPage.deliveryMethodRadioGroup(this.page);
    readonly deliveryContinueButton = InsinkeratorEuObjects.CheckoutPage.deliveryContinueButton(this.page);

    // --- VERIFIED: billing step ---
    readonly billingSameAsDeliveryCheckbox = InsinkeratorEuObjects.CheckoutPage.billingSameAsDeliveryCheckbox(this.page);
    readonly billingContinueButton = InsinkeratorEuObjects.CheckoutPage.billingContinueButton(this.page);
    readonly billingAddressOptions = InsinkeratorEuObjects.CheckoutPage.billingAddressOptions(this.page);
    readonly billingAddressContinueButton = InsinkeratorEuObjects.CheckoutPage.billingAddressContinueButton(this.page);

    // --- VERIFIED: review-and-payment step, including real CyberSource payment ---
    readonly reviewContent = InsinkeratorEuObjects.CheckoutPage.reviewContent(this.page);
    readonly reviewPaymentProviderErrorAlert = InsinkeratorEuObjects.CheckoutPage.reviewPaymentProviderErrorAlert(this.page);
    readonly placeOrderButton = InsinkeratorEuObjects.CheckoutPage.placeOrderButton(this.page);
    readonly checkoutWithCardButton = InsinkeratorEuObjects.CheckoutPage.checkoutWithCardButton(this.page);
    readonly cyberSourceCardNumberInput = InsinkeratorEuObjects.CheckoutPage.cyberSourceCardNumberInput(this.page);
    readonly cyberSourceExpiryMonthSelect = InsinkeratorEuObjects.CheckoutPage.cyberSourceExpiryMonthSelect(this.page);
    readonly cyberSourceExpiryYearSelect = InsinkeratorEuObjects.CheckoutPage.cyberSourceExpiryYearSelect(this.page);
    readonly cyberSourceSecurityCodeInput = InsinkeratorEuObjects.CheckoutPage.cyberSourceSecurityCodeInput(this.page);
    readonly cyberSourceCardContinueButton = InsinkeratorEuObjects.CheckoutPage.cyberSourceCardContinueButton(this.page);
    readonly cyberSourceConfirmAndContinueButton = InsinkeratorEuObjects.CheckoutPage.cyberSourceConfirmAndContinueButton(this.page);

    // --- UNVERIFIED placeholders kept for abstract-contract compatibility ---
    readonly payOnAccountButton = InsinkeratorEuObjects.CheckoutPage.payOnAccountButton(this.page);
    readonly proceedButton = InsinkeratorEuObjects.CheckoutPage.proceedButton(this.page);
    readonly deliveryOptionsDiv = InsinkeratorEuObjects.CheckoutPage.deliveryOptionsDiv(this.page);
    readonly deliveryOptionsSlotsDiv = InsinkeratorEuObjects.CheckoutPage.deliveryOptionsSlotsDiv(this.page);
    ...
    async continueAsGuest(email: string): Promise<void> {
        ...
        // InsinkeratorEuLoginPage for why (a real run showed
     ...
     * InsinkeratorEuCheckoutSuccessPage.verifyThankYouPage() for the
    ...
    async enterDeliveryPhoneNumberAndContinue(ukFormatPhoneNumber: string): Promise<void> {
        // NOTE: fill() rather than pressSequentially() — see
        // InsinkeratorEuLoginPage for why.
