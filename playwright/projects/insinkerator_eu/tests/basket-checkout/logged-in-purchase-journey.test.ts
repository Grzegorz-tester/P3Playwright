 ...
 * (see InsinkeratorEuHomePage.chooseMenuCategory()): the "Navigate to Shop
 ...
 * category) - see InsinkeratorEuProductListPage.clickOnFirstItemToProceedToPDP().
 *
 ...
 * fill-and-verify retry to be reliable — see InsinkeratorEuLoginPage.ts).
 */
