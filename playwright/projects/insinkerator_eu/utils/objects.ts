...
export const InsinkeratorEuObjects = {
    ...
    HomePage: {
        ...
        // clickable with a plain click. InsinkeratorEuHomePage.chooseMenuCategory()
    ...
    SearchDrawer: {
        ...
        // InsinkeratorEuHomePage.closeSearchDrawer() does via raw
        // page.mouse events rather than .click(). Escape does NOT work as
        // an alternative.
        closeButton: (page: Page) => InsinkeratorEuObjects.SearchDrawer.drawer(page).getByRole('button', { name: 'Close' })
    ...
    AccountPage: {
        ...
        resetPasswordButton: (page: Page) => InsinkeratorEuObjects.AccountPage.myDetailsForm(page).getByText('Reset Password'),
        ...
        changePasswordSaveButton: (page: Page) => InsinkeratorEuObjects.AccountPage.changePasswordForm(page).getByRole('button', { name: 'Save Changes' }).locator(':visible').first(),
        backToUserFormButton: (page: Page) => InsinkeratorEuObjects.AccountPage.changePasswordForm(page).getByText('Back to User Form'),
        ...
        ordersNoResultsRow: (page: Page) => InsinkeratorEuObjects.AccountPage.ordersContent(page).getByText('No results.'),
        ...
        deliveryAddressFirstNameInput: (page: Page) => InsinkeratorEuObjects.AccountPage.deliveryAddressForm(page).getByTestId('checkout-address-form__first-name'),
        deliveryAddressLastNameInput: (page: Page) => InsinkeratorEuObjects.AccountPage.deliveryAddressForm(page).getByTestId('checkout-address-form__last-name'),
        deliveryAddressLine1Input: (page: Page) => InsinkeratorEuObjects.AccountPage.deliveryAddressForm(page).getByTestId('checkout-address-form__address-line-1'),
        deliveryAddressCityInput: (page: Page) => InsinkeratorEuObjects.AccountPage.deliveryAddressForm(page).getByTestId('checkout-address-form__city'),
        deliveryAddressPostcodeInput: (page: Page) => InsinkeratorEuObjects.AccountPage.deliveryAddressForm(page).getByTestId('checkout-address-form__postcode'),
        ...
        deliveryAddressSaveButton: (page: Page) => InsinkeratorEuObjects.AccountPage.deliveryAddressForm(page).locator('button[type="submit"]'),
        ...
        billingAddressFirstNameInput: (page: Page) => InsinkeratorEuObjects.AccountPage.billingAddressForm(page).getByTestId('checkout-address-form__first-name'),
        billingAddressLastNameInput: (page: Page) => InsinkeratorEuObjects.AccountPage.billingAddressForm(page).getByTestId('checkout-address-form__last-name'),
        billingAddressLine1Input: (page: Page) => InsinkeratorEuObjects.AccountPage.billingAddressForm(page).getByTestId('checkout-address-form__address-line-1'),
        billingAddressCityInput: (page: Page) => InsinkeratorEuObjects.AccountPage.billingAddressForm(page).getByTestId('checkout-address-form__city'),
        billingAddressPostcodeInput: (page: Page) => InsinkeratorEuObjects.AccountPage.billingAddressForm(page).getByTestId('checkout-address-form__postcode'),
        billingAddressSaveButton: (page: Page) => InsinkeratorEuObjects.AccountPage.billingAddressForm(page).locator('button[type="submit"]'),
    ...
    ProductListPage: {
        ...
        // clickFirstResult() in InsinkeratorEuProductListPage.ts.
        productNameLink: (page: Page) => page.getByTestId('product-card__name'),
    ...
    CheckoutPage: {
        ...
        // in InsinkeratorEuCheckoutPage.ts for why fill() won't trigger it)
