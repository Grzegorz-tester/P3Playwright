...
export class CarbonHomePage extends HomePage {
    ...
    get category(): Locator {
        return CarbonObjects.HomePage.category(this.categoryName)(this.page);
    }
    readonly brandBar = CarbonObjects.HomePage.brandBar(this.page);
    readonly menuNavBarButton = CarbonObjects.HomePage.menuNavBarButton(this.page);
    readonly viewAllButton = CarbonObjects.HomePage.viewAllButton(this.page);
