...
export class InsinkeratorBasketPage extends BasketPage {
    ...
    readonly firstLineName = InsinkeratorObjects.BasketPage.lineName(0)(this.page);
    readonly firstLineSku = InsinkeratorObjects.BasketPage.lineSku(0)(this.page);
    readonly firstLineTotalPrice = InsinkeratorObjects.BasketPage.lineTotalPrice(0)(this.page);
    readonly firstLineExtraOptions = InsinkeratorObjects.BasketPage.lineExtraOptions(0)(this.page);
    readonly summaryTotal = InsinkeratorObjects.BasketPage.summaryTotal(this.page);
    readonly quantityInput = InsinkeratorObjects.BasketPage.quantityInput(this.page);
    readonly quantityMinusButton = InsinkeratorObjects.BasketPage.quantityMinusButton(this.page);
    readonly quantityPlusButton = InsinkeratorObjects.BasketPage.quantityPlusButton(this.page);
    readonly promoCodeToggleButton = InsinkeratorObjects.BasketPage.promoCodeToggleButton(this.page);
    readonly promoCodeInput = InsinkeratorObjects.BasketPage.promoCodeInput(this.page);
    readonly promoCodeError = InsinkeratorObjects.BasketPage.promoCodeError(this.page);
