...
export class KooltechProductListPage extends AbstractProductListPage {

    constructor(page: Page) {
        super(page);
    }

    readonly productNameLink = KooltechObjects.ProductListPage.productNameLink(this.page);
    ...
    async clickOnAProductToProceedToPDP(productName: string): Promise<void> {
        const productLink = KooltechObjects.ProductListPage.productNameLinkFiltered(productName)(this.page)
